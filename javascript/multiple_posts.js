$(document).on('turbolinks:load', function(){
  ...
  $('#image-box-icon').on('click', function() {
    // debugger
    var lastIndex = $('.input-field__contents:last').data('index');
    console.log(lastIndex)
    //ここで、「trigger」を利用して「クリックイベント」を呼び出します
    // debugger
    $(`#item_images_attributes_${lastIndex}_item_image`).trigger('click')
    console.log($('.input-field__contents:last'))
